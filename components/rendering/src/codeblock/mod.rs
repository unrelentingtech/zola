...
fn opening_html(language: Option<&str>, pre_style: Option<String>, pre_class: Option<String>, line_numbers: bool) -> String {
...
impl<'config> CodeBlock<'config> {
    pub fn new<'fence_info>(
        ...
        let html_start = opening_html(fence.language, highlighter.pre_style(), highlighter.pre_classes(), fence.line_numbers);
        (
            Self {
                highlighter,
